...
import ca.concordia.cssdev.plugin.wizards.dependenciesvisualization.SelectorSearchWizard;


public class DependenciesVisualizationView extends ViewPart {
	
	public static final String ID = "ca.concordia.cssdev.plugin.views.dependenciesvisualization.DependenciesVisualizationView";
